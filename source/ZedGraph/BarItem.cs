  ...
  public class BarItem : CurveItem, ICloneable, IBarItem
  {
    ...
    public static void CreateBarLabels(GraphPane pane, bool isBarCenter, string valueFormat)
    {
      CreateBarLabels(pane, isBarCenter, valueFormat, TextObj.Default.FontFamily,
                      TextObj.Default.FontSize, TextObj.Default.FontColor,
    ...
    public static void CreateBarLabels(GraphPane pane, bool isBarCenter, string valueFormat,
                                       string fontFamily, float fontSize, Color fontColor,
      ...
      foreach (var curve in pane.CurveList)
      {
        ...
        if (bar != null)
        {
          ...
          for (var i = 0; i < points.Count; i++)
          {
            ...
            var barLabelText =
              (isVertical ? points[i].Y : points[i].X).ToString(valueFormat);
