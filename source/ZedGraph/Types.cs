...
{  
  ...
  /// <summary>
  /// Panning and Zooming actions allowed for mouse wheel movement
  /// </summary>
  [Flags]
  public enum MouseWheelActions
  {
    ...
    /// <summary>
    /// Pan current pane vertically
    /// </summary>
    PanV = 1 << 1,

    /// <summary>
    /// Pan current pane horizontally or vertically
    /// This value is reserved for internal use, as the mouse wheel action
    /// would only be used to pan in one direction at a time
    /// </summary>
    PanHorV = PanH | PanV,

    /// <summary>
    /// Zoom current pane horizontally
    /// </summary>
    ZoomH = 1 << 2,

    /// <summary>
    /// Zoom current pane vertically
    /// </summary>
    ZoomV = 1 << 3,
  ...
  /// <summary>
  /// Kind enumerator associated with a value representation
  /// </summary>
  public enum StepKind
  {
    /// <summary>
    /// Underlying value represents percentage
    /// </summary>
    Percentage,

    /// <summary>
    /// Underlying value is absolute 
    /// </summary>
    Value
  }
