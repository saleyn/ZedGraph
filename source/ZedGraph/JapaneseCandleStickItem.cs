...
namespace ZedGraph
{
  ...
  public class JapaneseCandleStickItem : CurveItem, ICloneable, IBarItem
  {
    ...
    /// </summary>
    private const int schema2 = 10;

    private float _dotSize     = 1f;
    private float _dotHalfSize = 0.5f;
    ...
    {
      if (IsVisible)
        Stick.Draw(g, pane, this, BaseAxis(pane), ValueAxis(pane), scaleFactor);
    }
    ...
    public override bool GetCoords(GraphPane pane, int i, out string coords)
    {
          ...
          (((high > 0) && (low > 0)) || !valueAxis.Scale.IsLog))
      {
        ...
        // Draw the bar
        coords = baseAxis is XAxis || baseAxis is X2Axis
